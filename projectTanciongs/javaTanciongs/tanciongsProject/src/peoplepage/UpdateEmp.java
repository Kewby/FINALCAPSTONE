...
//        }       
    ...
    private void initComponents() {
        ...
        comboRole.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "---", "CASHIER", "ADMIN" }));
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        if(txtFirstName.getText().trim().equals("") || txtLastName.getText().trim().equals("") 
            ...
            int role = comboRole.getSelectedItem().toString().compareToIgnoreCase("ADMIN")==0?1:0;
            
            if (JOptionPane.showConfirmDialog(null, "Are you sure you want to update this?", "Confirm Update",
                    JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
                try {
                    uec.update(empID, firstName,lastName,username,password,email,contactNumber,address,role);
